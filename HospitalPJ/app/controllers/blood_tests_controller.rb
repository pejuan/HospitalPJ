class BloodTestsController < ApplicationController
  ...
  private
    ...
    def blood_test_params
      params.require(:blood_test).permit(:test_date, :erythrocytes, :hemoglobin, :vcm, :hcm, :lymphocytes, :leukocytes, :neutrophils, :eosinofilos, :platelets, :vsg, :patient_id, :microbiologist, :examination_cost)
    end
end
